...
# Add path manipulation for robust imports
import os
import sys
...
# Import updated modules - now these should work regardless of where the script is run from
try:
    from database_service import DatabaseService
    print("Successfully imported DatabaseService directly")
except ImportError:
    try:
        from services.database_service import DatabaseService
        print("Successfully imported DatabaseService from services")
    except ImportError:
        try:
            from app.services.database_service import DatabaseService
            print("Successfully imported DatabaseService from app.services")
        except ImportError:
            print("ERROR: Could not import DatabaseService. Check file paths.")
            sys.exit(1)
...
try:
    ...
    try:
        ...
        try:
            ...
            print("ERROR: Could not import ChemicalSafetyDatabase. Check file paths.")
            sys.exit(1)
...
try:
    ...
    try:
        from services.test_strip_analyzer import TestStripAnalyzer
    except ImportError:
        try:
            from app.services.test_strip_analyzer import TestStripAnalyzer
        except ImportError:
            print("ERROR: Could not import TestStripAnalyzer. Check file paths.")
            sys.exit(1)
...
try:
    ...
    try:
        ...
        try:
            ...
            print("ERROR: Could not import WeatherService. Check file paths.")
            sys.exit(1)
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print("Successfully imported TabBasedUI directly")
                except ImportError:
                    try:
                        from ui.tab_based_ui import TabBasedUI
                        print("Successfully imported TabBasedUI from ui")
                    except ImportError:
                        try:
                            from app.ui.tab_based_ui import TabBasedUI
                            print("Successfully imported TabBasedUI from app.ui")
                        except ImportError:
                            print("ERROR: Could not import TabBasedUI. Check file paths.")
                            raise
