...
def update_pool_app():
    ...
    # Path to the pool_app.py file
    pool_app_path = '/workspace/Deep-Blue-Pool-Chemistry/pool_app.py'
...
def create_integration_file():
    ...
    integration_file_path = '/workspace/Deep-Blue-Pool-Chemistry/integrate_enhancements.py'
